const en = {
  ...
  start_now: 'Start Now',
  continue: 'Continue',
  document_signed_book_appointment: 'Document Signed - Book Appointment',
  great_next_step_schedule_meeting: 'Great! The next step is to schedule a meeting with us.',
  schedule_appointment: 'Schedule Appointment',
  skip_for_now: 'Skip for Now',
  skip_appointment_booking: 'Skip appointment booking',
  sign_now: 'Sign Now',
